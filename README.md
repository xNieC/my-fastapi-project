...
[![codecov](https://codecov.io/gh/xNieC/my-fastapi-project/branch/main/graph/badge.svg?token=my-fastapi-project_token_here)](https://codecov.io/gh/xNieC/my-fastapi-project)
[![CI](https://github.com/xNieC/my-fastapi-project/actions/workflows/main.yml/badge.svg)](https://github.com/xNieC/my-fastapi-project/actions/workflows/main.yml)

Awesome my_fastapi_project created by xNieC

## Install

from source
```bash
git clone https://github.com/xNieC/my-fastapi-project my_fastapi_project
